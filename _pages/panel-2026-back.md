---
title: Panel (2026, retired)
published: false
# Superseded by the FFRise Forum on 2026-08-09. Kept for reference only:
# published:false means Jekyll never builds it, and it deliberately has no
# permalink so it can never collide with /panel/.
---
...
<br/>
<b>Panel Coordinator:</b><br/>
Dr. Wanlun Ma, Swinburne University of Technology, Australia<br/>
<br/>
<b>Venue:</b> RMIT, Melbourne, Australia<br/>
...
<img src="{{ '/assets/images/panel_speaker/chao_chen.jpg' | relative_url }}" align="left" style="border:10px solid white" width="200">
